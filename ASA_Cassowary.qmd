...
# Log Sightings
# Cleveland plot
dotchart(cassowary$LogSightings,          
         pch=16, col=col_transp,          
         xlab='Log observation',          
         main = 'Cleveland plot',          
         cex=0.8) 
# Histogram
hist(cassowary$LogSightings,      
     col=col_transp, 
     border="white",      
     xlab="Log observation",      
     main = 'Histogram',      
     breaks=20)
# Quantile-Quantile plot
qqnorm(cassowary$LogSightings, pch=16, col=col_transp, xlab='', ylab='',main="QQ plot")
qqline(cassowary$LogSightings, col='red', lwd=2)
```
