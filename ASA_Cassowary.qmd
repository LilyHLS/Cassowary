...
hist(cassowary_filtr$Sightings,      
     ...
     breaks=20)
# Quantile-Quantile plot 
qqnorm(cassowary_filtr$Sightings, pch=16, col=col_transp, xlab='', ylab='',main="QQ plot") 
...
mapview(p_abs %>% filter(abs == "abs"), zcol = "abs", col.regions = "white") + 
  mapview(p_abs %>% filter(abs == "pres"), zcol = "Sightings")
```
