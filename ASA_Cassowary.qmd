...
*Hypothesis: We assume that southern cassowary is mainly distributed near its natural habitat or in areas where food is available. We expect that high proportions of rainforest and fruits are associated with greatest cassowary abundance. We also assume that traffic strike occur when the road is at a low distance from the centroid of the grid cell and that risk is higher when the road connects to favorable habitat.*
...
Here, we study the variable called Sightings, which is the result of counting Cassowaries seen in the patches in the studied area during 12 years.
...
Beaucoup de 0, la plupart des valeurs entre 0 et 100
faire le summary et le comptage des valeurs à 0
outliers : comptages
biblio à intégrer
