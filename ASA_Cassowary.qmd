...
#### Distribution of the response variable Strikes $Y$ {.unnumbered}
...
With the Poisson distribution, residuals are overfitted so we switch to a Negative Binomial distribution.

```{r}
glm_nb_strikes <- glm.nb(Strikes ~ scale(Total_Road) + scale(Dresid) + scale(Dfruit) + LogSightings,data = cassowary)
