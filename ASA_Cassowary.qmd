...
Furthermore, in the initial study (@dwyer_using_2016), each cassowary sighting is dated, allowing for temporal analyses that take sampling bias into account. 