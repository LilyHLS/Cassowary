...
![](images/clipboard-1642165662.png)
...
*Hypothesis: We assume that southern cassowary is mainly distributed near its natural habitat or in areas where food is available. We expect that high proportions of rainforest and fruits are associated with greatest cassowary abundance. We also assume that traffic strike ocur when the road is at a low distance from the centroïde of the grid cell and that risk is higher when the road connects two favorable habitat.*
