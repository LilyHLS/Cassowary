...
# Statistical Analysis : Abundance ~ environmental variables
...
# Statistical Analysis : Strikes ~ environmental variables

# Study limitations
However, our results should be treated with caution as they are based on citizen science data. 
Furthermore, in the initial study (@dwyer_using_2016), each cassowary sighting ans striking is dated, allowing for temporal analyses that take sampling bias into account. 