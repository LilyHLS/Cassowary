...
Should we keep this part? Does Dharma is enough? I haven't done that for the mortality model
...
- $\varepsilon$ the residuals,\
- $X_i$ the independent variables Here, we model $log(\mu_i) = \alpha + \beta_1Raiforest_i + \beta_2Residential.P_i + \beta_3Fruit.P_i + \beta_4TotalRoad +\varepsilon_{i}$
